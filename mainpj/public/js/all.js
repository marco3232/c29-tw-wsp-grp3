...
document.querySelector(
  ".first"
    ...
    <div class="container-fluid">
      <a class="navbar-brand" href="https://youtu.be/L3z6rcD_LQ8?t=22">鬼滅之刃傭</a>
      ...
      <div class="collapse navbar-collapse" id="navbarsExample04">
        ...
        <a class="bi bi-person-fill" onclick="goToLink('personal_page.html')"></a>

        <a class="bi bi-cart2" onclick="goToLink('cart.html')"></a>
      </div>
    </div>
  </nav>`;
